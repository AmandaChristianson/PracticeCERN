...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QToolTip, QComboBox, QTextEdit, QFileDialog, QVBoxLayout, QHBoxLayout
from PyQt5.QtGui import QFont

def small_window():
    class Window(QWidget):

        def __init__(self): #Creates an init method (private?)
            super(Window, self).__init__() #Super return the parent object of the class
        ...
        def initUI(self):
            ...
            self.setWindowTitle('GUI') #Sets the window title
    ...
    ex = Window()
    sys.exit(app.exec_()) #Ensures that the program ends correctly (?)
